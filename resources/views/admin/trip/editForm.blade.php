...
@section('content')
    ...
    {{ Form::text('sNameTrip', $oTripData->trip_name, ['class' => 'form-control', 'required']) }}
    {{ Form::label('iYearTrip', 'Jaar') }}
    {{ Form::text('iYearTrip', $oTripData->trip_year, ['class' => 'form-control', 'required']) }}
    {{ Form::label('iPriceTrip', 'Kostprijs') }}
    {{ Form::text('iPriceTrip', $oTripData->trip_price, ['class' => 'form-control', 'required']) }}
